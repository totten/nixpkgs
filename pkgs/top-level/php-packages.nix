      ...
      extensionData = [
        ...
        { name = "calendar"; }
        {
                ...
                postPatch = lib.optionalString stdenv.hostPlatform.isDarwin ''
                  ...
                  if [ -f ext/ctype/tests/lc_ctype_inheritance.phpt ]; then rm ext/ctype/tests/lc_ctype_inheritance.phpt ; fi
                '';
        }
        {
          name = "curl";
        ...
        { name = "dba"; }
        {
          ...
          patches = lib.optionals ((lib.versions.majorMinor php.version == "8.2" && lib.versionOlder php.version "8.2.14" && lib.versionAtLeast php.version "8.2.7") || (lib.versions.majorMinor php.version == "8.1" && lib.versionOlder php.version "8.1.31" && lib.versionAtLeast php.version "8.1.27")) [
